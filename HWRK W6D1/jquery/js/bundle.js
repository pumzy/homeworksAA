...
View.prototype.exercise4 = function () {
  ...
  //your code here!
  $('.square:nth-of-type(odd)').append('Amaar')
};
...
View.prototype.exercise5 = function () {
  ...
  //your code here!
  $('.square').click( ev => alert($(ev.currentTarget).attr('data-pos')));
  };
...
View.prototype.exercise6 = function () {
  ...
  $('.square').each( (idx,el) => $(el).css('background-color', _randomColorString()))
  //your code here!
};
...
View.prototype.exercise7 = function(){
  ...
  //your code here!
  $('.square').hover( ev => console.log($(ev.currentTarget).css("background-color")));
};
